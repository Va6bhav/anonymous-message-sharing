      ...
      <div className="w-full max-w-md p-10 space-y-8 bg-white/90 rounded-2xl shadow-lg backdrop-blur-sm">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            />
            <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg shadow-lg transition-all" disabled={isSubmitting}>
              {isSubmitting ? (
                <>
